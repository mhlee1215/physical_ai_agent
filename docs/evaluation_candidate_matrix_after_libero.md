...
| Parity ablation | Meta-World `very_hard` | 5 tasks, 10 trials/task | task success | seed `0` corrected-rename run `20.0`; seed `1000` run `26.0` | SmolVLA Table 2 Very Hard `60.0` | Seed helps only modestly; not enough to explain the gap |
