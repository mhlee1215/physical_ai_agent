...
- `PYTHONPATH=src python3 scripts/mycobot_nexus_smoke.py --asset-root _vendor/mycobot_mujoco --output-dir _workspace/mycobot_nexus_grasp_lift --policy grasp-lift`
