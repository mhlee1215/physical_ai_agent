...
class LoopTestAnalyzerTest(unittest.TestCase):
    ...
    def test_dataset_viewer_closed_loop_preview_http_e2e(self) -> None:
        ...
        self.assertIn('class="training-runs-shell"', html)
        self.assertIn("Delete selected runs", html)
        self.assertIn("new Tabulator(trainingRuns", html)
        self.assertIn('className = "training-select-checkbox training-select-page-checkbox"', html)
        self.assertIn('className = "training-select-checkbox training-row-select-checkbox"', html)
        self.assertIn('fetch("/api/training/runs/bulk-delete"', html)
        self.assertIn('"X-Training-Delete-Confirmation": required', html)
        self.assertIn("The active training run cannot be deleted", html)
