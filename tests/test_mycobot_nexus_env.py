...
""".strip(),
    ...
    def test_scene_builder_can_use_ros2_320_adaptive_gripper_profile(self) -> None:
        ...
        self.assertIn("act_gripper_controller", actuator_names)
        self.assertIn("act_gripper_base_to_gripper_left2", actuator_names)
        self.assertIn("act_gripper_right3_to_gripper_right1", actuator_names)
