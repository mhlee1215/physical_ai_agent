...
def _write_reference_table(path: Path) -> None:
    lines = [
        ...
        "",
        "Official leaderboard snapshot checked 2026-06-07.",
        "",
        ...
        "| Our SmolVLA RoboCasa365 run | pending | pending | pending | pending |",
        "",
        "Comparison rule: do not compare CP25 import/reset smoke to this table. Only",
        "compare after running `lerobot/smolvla_robocasa` under the same RoboCasa365",
        "20-episodes-per-task protocol.",
        "",
        "Sources:",
        "",
